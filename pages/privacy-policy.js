      ...
      <div className="page_container">
        ...
        <div className="page_section">
          <div className="para_content">
            ...
            <p>When you use a website, mobile application or other internet service, certain internet and electronic network activity information gets created and logged automatically. Here are some of the types of information we collect:
            </p>
            <ul>
